...
网页包含独立的能力提升工作台。它以 68 个 A 档岗位为样本，首页介绍 13 项能力及其关系，并可从首页或侧栏进入单项训练；另有 16 周执行路线、14 项作品集和 A-/A+ 投递检查清单。业务英语已提供 6 个剧情章节、30 道真实工作情境题，包括热身选择、句子排序、短答练习和 Boss 挑战。用户必须先作答才能查看参考答案，并在四项自评中确认三项后逐题解锁。
